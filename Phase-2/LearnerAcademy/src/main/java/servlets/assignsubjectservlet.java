...
//				out.println("<h2 style='color:red;font-weight:bold;'>Select Students Before Assigning!!!</h2>");
				...
				out.println("<script>document.getElementById('messagespace').innerHTML='"+subss_ids.length+" Subject(s) has been added to the class "+stud_class+" of the section "+stud_section+"';</script>");	
			}
		}
	}
}
